...
\begin{table}[ht]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|l|}
            ...
            Time                                                                                            & Namespace utilizado para establecer una hora del sistema diferente a la del sistema global.                                                                                                                              \\ \hline
            \textbf{Network}                                                                                & Namespace utilizado para crear una réplica aislada del stack de red del sistema dentro del propio sistema.                                                                                                               \\ \hline
            \textbf{User}                                                                                   & Namespace utilizado para aislar un grupo de usuarios.                                                                                                                                                                    \\ \hline
            \textbf{PID}                                                                                    & Namespace utilizado para tener identificadores de proceso independientes de otras namespaces.                                                                                                                            \\ \hline
