...
\begin{table}[ht!]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|
            ...
            Solidez                                                               & \cellcolor[HTML]{34FF34}Más sólido dado que tienen una comunidad más grande & \cellcolor[HTML]{F8A102}{\color[HTML]{333333} Sistema de test bastante pobre}    \\ \hline
            ...
            Rendimiento                                                           & \cellcolor[HTML]{34FF34}Alto rendimiento                                    & \cellcolor[HTML]{F8A102}Es un script de Python, lenguaje interpretado            \\ \hline
