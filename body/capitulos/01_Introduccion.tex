...
\\
Por consiguiente, muchos de los esfuerzos de las instituciones están pasando por impulsar las redes \gls{6g}-\gls{iot}. Desde Europa se está impulsando la carrera por el \gls{6g} poniendo sobre la mesa una hoja de ruta dividida en cuatro fases diferenciadas, esperando poder finalizar en 2030 \cite{eu6GFases}.



EU’s Smart Networks and Services Joint Undertaking (SNS JU). The launch followed the formal decision of the SNS Governing Board in July and today’s presentation of the portfolio at the SNS States Representative Group (SRG).
